...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	return {
		...
		"s-3103-1000-153-0": [{ type: "text", class_position: "tank", sub_type: "message", message: "2 Chutes", message_RU: "Два удара" }], // 153 108
		...
		"s-3103-1000-110-0": [
			{ type: "text", sub_type: "message", message: "Giro", message_RU: "Крутилка" },
