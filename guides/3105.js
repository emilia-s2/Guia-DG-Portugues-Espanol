...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	return {
		...
		// Donuts combo <80%
		"qb-3105-1000-31051013": [{ type: "text", sub_type: "message", message: "Donuts: Out > In > Dodge", message_PT: "Donuts: Sair> Entrar> Esquiva" }],
		"qb-3105-1000-31051014": [{ type: "text", sub_type: "message", message: "Donuts: In > Out > Dodge", message_PT: "Donuts: Entrar > Sair > Esquiva" }],
		"s-3105-1000-115-0": [
		...
		"qb-3105-1000-31051004": [{ type: "text", sub_type: "message", message: "Bait", message_PT: "Bait" }], // range check
