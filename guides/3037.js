...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	return {
		...
		"s-3037-1000-1113-0": [{ type: "text", sub_type: "message", message: "Throw (Bait)", message_ES: "Bait (Iframe)", message_PT: "Bait (Iframe)" }],
		"s-3037-1000-1114-0": [
		...
		"s-3037-1000-1115-0": [{ type: "text", sub_type: "message", delay: 1100, message: "Dodge", message_ES: "Iframe", message_PT: "Iframe" }], // Knockup
		"s-3037-1000-1116-0": [
		...
		"s-3037-1000-1117-0": [{ type: "text", sub_type: "message", message: "Jump (Bait)", message_ES: "Salto (Bait)", message_PT: "Pular (Bait)" }],
		"s-3037-1000-1118-0": [{ type: "text", sub_type: "message", message: "Jump (Tank)", message_ES: "Salto (Tank)", message_PT: "Pular (Tank)" }],
...
//			{ type: "spawn", func: "marker", args: [false, 143, 125, 0, 2533, false, ["safe", "safe"]] }
		...
		"s-3037-1000-1131-0": [
			...
			{ type: "text", sub_type: "message", delay: 1350, message: "Dodge", message_ES: "Iframe", message_PT: "Iframe" },
		...
		"s-3037-1000-1138-0": [{ type: "text", sub_type: "message", delay: 1100, message: "Dodge", message_ES: "Iframe", message_PT: "Iframe" }], // Knockup (Bait)
		"s-3037-1000-1139-0": [
			{ type: "text", sub_type: "message", delay: 600, message: "Dodge!", message_ES: "Tumbar (Esquiva)", message_PT: "Rebater (Iframe)!" },
...
//			{ type: "spawn", func: "marker", args: [false, 217, 125, 0, 2533, false, ["safe", "safe"]] }
		...
		"s-3037-1000-2115-0": [{ type: "text", sub_type: "message", message: "Dodge", message_ES: "Iframe", message_PT: "Iframe" }], // Knockup
		...
		"s-3037-1000-2138-0": [{ type: "text", sub_type: "message", message: "Dodge", message_ES: "Iframe", message_PT: "Iframe" }], // Knockup (Bait)
		...
		"s-3037-2000-1107-0": [{ type: "text", sub_type: "message", message: "4 Hit (3)", message_ES: "4 Hit (3)", message_PT: "4 Hit (3)" }],
		"s-3037-2000-1108-0": [
		...
		"s-3037-2000-1112-0": [
			{ type: "text", sub_type: "message", delay: 1240, message: "Perfect Defense", message_ES: "Defesa Perfecta", message_PT: "Defesa Perfeita" },
			{ type: "spawn", func: "circle", args: [false, 553, 356, 220, 12, 210, 100, 3000] }
		],
		"s-3037-2000-1113-0": [{ type: "text", sub_type: "message", message: "Throw (Bait)", message_ES: "Bait (Iframe)", message_PT: "Bait (Iframe)" }],
		"s-3037-2000-1114-0": [
			{ type: "text", sub_type: "message", message: "Front Slam", message_ES: "Frente Slam", message_PT: "Frente Slam" },
			{ type: "spawn", func: "circle", args: [false, 553, 356, 260, 10, 320, 100, 3000] }
		],
		"s-3037-2000-1115-0": [{ type: "text", sub_type: "message", delay: 1100, message: "Dodge", message_ES: "Iframe", message_PT: "Iframe" }], // Knockup
		"s-3037-2000-1116-0": [
			{ type: "text", sub_type: "message", message: "Donuts (In)", message_ES: "Donuts (Entrar)", message_PT: "Donuts (Entrar)" },
		...
		"s-3037-2000-1117-0": [{ type: "text", sub_type: "message", message: "Jump (Bait)", message_ES: "Salto (Bait)", message_PT: "Pular (Bait)" }],
		"s-3037-2000-1118-0": [{ type: "text", sub_type: "message", message: "Jump (Tank)", message_ES: "Salto (Tank)", message_PT: "Pular (Tank)" }],
...
//			{ type: "spawn", func: "marker", args: [false, 143, 125, 0, 2500, false, ["safe", "safe"]] }
		...
		"s-3037-2000-1125-0": [
			...
			{ type: "text", sub_type: "message", delay: 1650, message: "Dodge", message_ES: "Iframe", message_PT: "Iframe" },
		...
		"s-3037-2000-1135-0": [
			{ type: "text", sub_type: "message", delay: 200, message: "Perfect Defense", message_ES: "Defesa Perfecta", message_PT: "Defesa Perfeita" },
			{ type: "spawn", func: "circle", args: [false, 553, 356, 220, 12, 210, 100, 3000] }
		],
		"s-3037-2000-1137-0": [
			{ type: "text", sub_type: "message", message: "Hammer back", message_ES: "Martillo Atrás", message_PT: "Martelo Atrás" },
		...
		"s-3037-2000-1138-0": [{ type: "text", sub_type: "message", delay: 1100, message: "Dodge", message_ES: "Iframe", message_PT: "Iframe" }], // Knockup (Bait)
		"s-3037-2000-1139-0": [{ type: "text", sub_type: "message", message: "Dodge!", message_ES: "Iframe", message_PT: "Iframe!" }],
		"s-3037-2000-1140-0": [
			{ type: "text", sub_type: "message", message: "Waves (Right)", message_ES: "Olas (DERECHA)", message_PT: "Ondas (DIREITA)" },
			{ type: "func", func: waves_event }
//			{ type: "spawn", func: "marker", args: [false, 323, 125, 0, 2533, false, ["safe", "safe"]] },
...
//			{ type: "spawn", func: "marker", args: [false, 217, 125, 0, 2500, false, ["safe", "safe"]] }
		...
		"s-3037-2000-1308-0": [{ type: "text", sub_type: "message", message: "Stun (1)", message_ES: "Stun (1)", message_PT: "Stun (1)" }],
		"s-3037-2000-1309-0": [{ type: "text", sub_type: "message", message: "Stun (2)", message_ES: "Stun (2)", message_PT: "Stun (2)" }],
		"s-3037-2000-1310-0": [{ type: "text", sub_type: "message", message: "Stun (3)", message_ES: "Stun (3)", message_PT: "Stun (3)" }],
		"s-3037-2000-1311-0": [
		...
		"s-3037-2000-2112-0": [
			{ type: "text", sub_type: "message", delay: 2000, message: "Perfect Defense", message_ES: "Defesa Perfecta", message_PT: "Defesa Perfeita" },
			{ type: "text", sub_type: "message", delay: 2700, message: "x2", message_ES: "x2", message_PT: "x2" },
		...
		"s-3037-2000-2115-0": [{ type: "text", sub_type: "message", message: "Dodge", message_ES: "Iframe", message_PT: "Iframe" }], // Knockup
		...
		"s-3037-2000-2135-0": [
			{ type: "text", sub_type: "message", delay: 200, message: "Perfect Defense", message_ES: "Defesa Perfecta", message_PT: "Defesa Perfeita" },
			{ type: "text", sub_type: "message", delay: 1535, message: "x2", message_ES: "x2", message_PT: "x2" },
			{ type: "spawn", func: "circle", args: [false, 553, 356, 220, 12, 210, 100, 4000] }
		],
		"s-3037-2000-2137-0": "s-3037-2000-1137-0",
		"s-3037-2000-2138-0": [{ type: "text", sub_type: "message", message: "Dodge", message_ES: "Iframe", message_PT: "Iframe" }], // Knockup (Bait)
		...
		"ab-3037-2000-90442303": [{ type: "text", sub_type: "message", message: "Plague/Regress", message_ES: "Plague/Regress", message_PT: "Plague/Regress" }],
		"ab-3037-2000-90442304": [
