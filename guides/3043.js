...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	return {
		...
		"s-3043-1000-106-0": [{ type: "text", sub_type: "message", message: "Push", message_PT: "Empurrar" }],
		"s-3043-1000-110-0": [{ type: "text", sub_type: "message", message: "Throw Front (Stun)", message_PT: "Lançar para a Frente (Stun)" }],
		...
		"s-3043-1000-124-0": [{ type: "text", sub_type: "message", message: "AoE", message_PT: "АоЕ" }],
		"s-3043-1000-125-0": [{ type: "text", sub_type: "message", message: "Hit | Frontal Stun", message_PT: "Golpe Frente | Stun" }],
		"s-3043-1000-126-0": [
		...
		"s-3043-1000-129-0": [{ type: "text", sub_type: "message", message: "Somersault | Back Hit", message_PT: "Salto Mortal | Golpe Atrás" }],
		"s-3043-1000-130-0": [
		...
		"s-3043-1000-142-0": [{ type: "text", sub_type: "message", message: "Frontal Combo", message_PT: "Combo Frontal" }],
		"s-3043-1000-301-0": [{ type: "text", sub_type: "message", message: "Circles (Target)", message_PT: "Círculos (Alvo)" }],
		"s-3043-1000-340-0": [
		...
		"s-3043-2000-106-0": [{ type: "text", sub_type: "message", message: "Push", message_PT: "Empurrar" }],
		"s-3043-2000-110-0": [{ type: "text", sub_type: "message", message: "Throw Front (Stun)", message_PT: "Lançar para a Frente (Stun)" }],
		...
		"s-3043-2000-124-0": [{ type: "text", sub_type: "message", message: "AoE", message_PT: "АоЕ" }],
		"s-3043-2000-125-0": [{ type: "text", sub_type: "message", message: "Hit | Frontal Stun", message_PT: "Golpe Frente | Stun" }],
		"s-3043-2000-126-0": [
			{ type: "text", sub_type: "message", message: "Frontal Stun", message_PT: "Frente Stun" },
			{ type: "spawn", func: "vector", args: [553, 60, 220, 20, 500, 0, 2000] },
			{ type: "spawn", func: "vector", args: [553, 300, 220, 340, 500, 0, 2000] }
		],
		"s-3043-2000-129-0": [{ type: "text", sub_type: "message", message: "Somersault | Back Hit", message_PT: "Salto Mortal | Golpe Atrás" }],
		"s-3043-2000-130-0": [
			{ type: "text", sub_type: "message", message: "Back Hit (Bleed)", message_PT: "Golpe Atrás (Sangramento)" },
			{ type: "spawn", func: "circle", args: [true, 553, 180, 340, null, 250, 0, 2000] }
		],
		"s-3043-2000-142-0": [{ type: "text", sub_type: "message", message: "Frontal Combo", message_PT: "Combo Frontal" }],
		"s-3043-2000-143-0": [{ type: "text", sub_type: "message", message: "Hit | Back Push", message_PT: "Golpe | Empurrão para Atrás" }],
		"s-3043-2000-143-1": [{ type: "text", sub_type: "message", message: "Back Push", message_PT: "Empurrão para Atrás" }],
		"s-3043-2000-144-0": [
		...
		"s-3043-2000-301-0": [{ type: "text", sub_type: "message", message: "Circles (Target)", message_PT: "Círculos (Alvo)" }],
		"s-3043-2000-340-0": [
			{ type: "text", sub_type: "message", message: "Laser", message_PT: "Laser" },
			{ type: "spawn", func: "vector", args: [912, 90, 50, 25, 300, 0, 2000] },
			{ type: "spawn", func: "vector", args: [912, 270, 50, 335, 300, 0, 2000] }
		...
		"qb-3043-2000-3043201": [{ type: "text", sub_type: "message", message: "Blue Circles (Safe)", message_PT: "Círculos Azuis (Seguro)" }],
		"qb-3043-2000-3043202": [{ type: "text", sub_type: "message", message: "Red Circles (Dodge)", message_PT: "Círculos Vermelhos (Esquiva)" }],
		"qb-3043-2000-3043400": [{ type: "text", sub_type: "message", message: "Break Statues", message_PT: "Quebrar Escudos das Státuas" }]
	};
};