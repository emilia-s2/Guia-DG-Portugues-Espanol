...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	return {
		...
		"s-3205-1000-303-0": [{ type: "text", sub_type: "message", message: "Kick (Push)", message_PT: "Chute (Empurrar)" }],

		// Donuts combo <80%
		"qb-3205-1000-32051013": [{ type: "text", sub_type: "message", message: "Donuts: Out > In > Dodge", message_PT: "Donuts: Sair> Entrar> Esquiva" }],
		"qb-3205-1000-32051014": [{ type: "text", sub_type: "message", message: "Donuts: In > Out > Dodge", message_PT: "Donuts: Entrar > Sair > Esquiva" }],
		"s-3205-1000-115-0": [
			...
			{ type: "text", sub_type: "message", delay: 4900, message: "Dodge", message_PT: "Esquiva" }
		],
		"s-3205-1000-116-0": [
			{ type: "spawn", func: "circle", args: [false, 445, 0, 0, 18, 180, 1500, 5000] },
			{ type: "spawn", func: "circle", args: [false, 445, 0, 0, 12, 360, 1500, 5000] },
		...
		"qb-3205-1000-32051004": [{ type: "text", sub_type: "message", message: "Bait", message_PT: "Bait" }], // range check
		...
		"qb-3205-1000-32051007": [{ type: "text", sub_type: "message", message: "Puddles", message_PT: "Poços" }], // <40%
		...
		"s-3205-1000-304-0": [ // red
			{ type: "text", sub_type: "message", message: "Dodge!", message_PT: "Esquiva!", delay: 200 },
