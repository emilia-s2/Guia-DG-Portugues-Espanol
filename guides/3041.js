...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	return {
		...
		"s-3041-1000-106-0": [{ type: "text", sub_type: "message", message: "Push", message_ES: "Empujar", message_PT: "Empurrar" }],
		"s-3041-1000-110-0": [{ type: "text", sub_type: "message", message: "Throw Front (Stun)", message_ES: "Lanzar Frente (Stun)", message_PT: "Lançar para a Frente (Stun)" }],
		...
		"s-3041-1000-124-0": [{ type: "text", sub_type: "message", message: "AoE", message_ES: "AoE", message_PT: "АоЕ" }],
		"s-3041-1000-125-0": [{ type: "text", sub_type: "message", message: "Hit | Frontal Stun", message_ES: "Golpe Frente | Stun", message_PT: "Golpe Frente | Stun" }],
		"s-3041-1000-126-0": [
		...
		"s-3041-1000-129-0": [{ type: "text", sub_type: "message", message: "Somersault | Back Hit", message_ES: "Salto Mortal | Golpe Atrás", message_PT: "Salto Mortal | Golpe Atrás" }],
		"s-3041-1000-130-0": [
		...
		"s-3041-1000-142-0": [{ type: "text", sub_type: "message", message: "Frontal Combo", message_ES: "Combo Frontal", message_PT: "Combo Frontal" }],
		"s-3041-1000-301-0": [{ type: "text", sub_type: "message", message: "Circles (Target)", message_ES: "Círculos (Objetivo)", message_PT: "Círculos (Alvo)" }],
		"s-3041-1000-340-0": [
		...
		"s-3041-2000-106-0": [{ type: "text", sub_type: "message", message: "Push", message_ES: "Empujar", message_PT: "Empurrar" }],
		"s-3041-2000-110-0": [{ type: "text", sub_type: "message", message: "Throw Front (Stun)", message_ES: "Lanzar Frente (Stun)", message_PT: "Lançar para a Frente (Stun)" }],
		...
		"s-3041-2000-124-0": [{ type: "text", sub_type: "message", message: "AoE", message_ES: "AoE", message_PT: "АоЕ" }],
		"s-3041-2000-125-0": [{ type: "text", sub_type: "message", message: "Hit | Frontal Stun", message_ES: "Golpe Frente | Stun", message_PT: "Golpe Frente | Stun" }],
		"s-3041-2000-126-0": [
			{ type: "text", sub_type: "message", message: "Frontal Stun", message_ES: "Frente Stun", message_PT: "Frente Stun" },
			{ type: "spawn", func: "vector", args: [553, 60, 220, 20, 500, 0, 2000] },
			{ type: "spawn", func: "vector", args: [553, 300, 220, 340, 500, 0, 2000] }
		],
		"s-3041-2000-129-0": [{ type: "text", sub_type: "message", message: "Somersault | Back Hit", message_ES: "Salto Mortal | Golpe Atrás", message_PT: "Salto Mortal | Golpe Atrás" }],
		"s-3041-2000-130-0": [
			{ type: "text", sub_type: "message", message: "Back Hit (Bleed)", message_ES: "Golpe Atrás (Sangrar)", message_PT: "Golpe Atrás (Sangramento)" },
			{ type: "spawn", func: "circle", args: [true, 553, 180, 340, null, 250, 0, 2000] }
		],
		"s-3041-2000-142-0": [{ type: "text", sub_type: "message", message: "Frontal Combo", message_ES: "Combo Frontal", message_PT: "Combo Frontal" }],
		"s-3041-2000-143-0": [{ type: "text", sub_type: "message", message: "Hit | Back Push", message_ES: "Golpe | Empujón Hacia Atrás", message_PT: "Golpe | Empurrão para Atrás" }],
		"s-3041-2000-143-1": [{ type: "text", sub_type: "message", message: "Back Push", message_ES: "Empujón Hacia Atrás", message_PT: "Empurrão para Atrás" }],
		"s-3041-2000-144-0": [
		...
		"s-3041-2000-301-0": [{ type: "text", sub_type: "message", message: "Circles (Target)", message_ES: "Círculos (Objetivo)", message_PT: "Círculos (Alvo)" }],
		"s-3041-2000-340-0": [
			{ type: "text", sub_type: "message", message: "Laser", message_ES: "Laser", message_PT: "Laser" },
			{ type: "spawn", func: "vector", args: [912, 90, 50, 25, 300, 0, 2000] },
			{ type: "spawn", func: "vector", args: [912, 270, 50, 335, 300, 0, 2000] }
		...
		"qb-3041-2000-3041201": [{ type: "text", sub_type: "message", message: "Blue Circles (Safe)", message_ES: "Círculos Azules  (Seguro)", message_PT: "Círculos Azuis (Seguro)" }],
		"qb-3041-2000-3041202": [{ type: "text", sub_type: "message", message: "Red Circles (Dodge)", message_ES: "Círculos Rojos  (Esquiva)", message_PT: "Círculos Vermelhos (Esquiva)" }],
		"qb-3041-2000-3041400": [{ type: "text", sub_type: "message", message: "Break Statues", message_ES: "Romper  Escudos de las Estatuas", message_PT: "Quebrar Escudos das Státuas" }]
	};
};