...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	return {
		...
		"s-3201-1000-149-0": [{ type: "text", sub_type: "message", message_PT: "Mão ESQUERDA (Voando)", message_ES: "Mano Izquierda (Volando)", message: "Left Hand (Flying)" },
		...
		"s-3201-1000-311-0": [
			...
			{ type: "text", sub_type: "message", delay: 4300, message_PT: "Iframe", message_ES: "Iframe", message: "Iframe!" }
		],
		"s-3201-1000-312-0": [
			{ type: "text", sub_type: "message", message_PT: "Repelir Full (Rápido)", message_ES: "Repeler Full (Rápido)", message: "Repel Full (Fast)" },
			{ type: "text", sub_type: "message", delay: 2300, message_PT: "Iframe", message_ES: "Iframe", message: "Iframe!" }
		],
		"s-3201-1000-313-0": [
