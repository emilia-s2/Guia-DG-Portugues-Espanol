...
module.exports = {
	...
	"s-3201-1000-107-0": [{ "type": "text", "sub_type": "message", "message": "Empurrar Atras (Lento)", "message_RU": "|Полоса|" }],
//						  { "type": "text", "sub_type": "message", "delay": 2250, "message": "pull", "message_RU": "Откид!!!" }
	...
	"s-3201-1000-113-0": [{ "type": "text", "sub_type": "message", "delay": 0, "message": "Pular (Lento)", "message_RU": "Прыжок" },
	...
	"s-3201-1000-118-0": [{ "type": "text", "sub_type": "message", "delay": 0, "message": "Pular (Lento)", "message_RU": "Прыжок" },
						  { "type": "text", "sub_type": "message", "delay": 1900, "message": "Iframe", "message_RU": "Камень!" }
	],
	//{ "type": "text", "sub_type": "notification", "delay": 1500, "message": "pull", "message_RU": "Камень!" }	
...
//	                     { "type": "func" ,"func": SpawnCircle.bind(null ,false, 445, 2, 180, 10, 320, 0, 4000) }
	...
	"s-3201-1000-311-0": [{ "type": "text", "sub_type": "message", "delay": 0, "message": "Ataque em Tela Cheia (Lento)", "message_RU": "Мёд!" },
                         { "type": "text", "sub_type": "message", "delay": 4200, "message": "Iframe", "message_RU": "Откид!" }
	],
	"s-3201-1000-312-0": [{ "type": "text", "sub_type": "message", "delay": 0, "message": "Ataque em Tela Cheia (Rapido)", "message_RU": "Мёд (фаст)!!!" },                                                                                       // 553,0,150,10,360,0,6000},                                                                                     
                         { "type": "text", "sub_type": "message", "delay": 2200, "message": "Iframe", "message_RU": "Откид!!!" } 
    ],						
	"s-3201-1000-313-0": [{ "type": "text", "sub_type": "message", "message": "DENTRO e FORA (Lento)", "message_RU": "Кольцо" }, { "type": "spawn_func", "func": "circle", "args": [false, 553, 0, 75, 10, 300, 0, 6000] }],
	"s-3201-1000-314-0": [{ "type": "text", "sub_type": "message", "message": "DENTRO e FORA (Rapido)", "message_RU": "Кольцо (фаст)" },{ "type": "spawn_func", "func": "circle", "args": [false, 553, 0, 75, 10, 300, 0, 6000] }],
...
//	"s-3201-2000-150-0": [{ "type": "text", "sub_type": "message", "message": "Phantom", "message_RU": "Фантом" }],
	...
	"am-3201-320126-32010224": [{ "type": "text", "sub_type": "notification", "delay": 52000, "message": "REAL Debuff em 5s", "message_RU": "След. правда" }, { "type": "func", "func": skilld_event.bind(null, 32010224) }],
	"am-3201-2000-32010220": [{ "type": "text", "sub_type": "notification", "delay": 52000, "message": "FAKE Debuff em 5s", "message_RU": "След. ложь" }, { "type": "func", "func": skilld_event.bind(null, 32010220) }],
//	    {"type": "text", "sub_type": "message", "delay": 51000, "message": "Toma Debuf fake", "message_RU": "Эвейд" }
	...
	"s-3201-2000-231-0": [{ "type": "text", "sub_type": "message", "message": "SAIR", "message_RU": "ОТ НЕГО" },
