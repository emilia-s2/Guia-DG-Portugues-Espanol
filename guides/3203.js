...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	return {
		...
		"h-3203-1000-30": [{ type: "text", sub_type: "message", message_PT: "30%", message_ES: "30%", message: "30%" }],

		"s-3203-1000-113-0": [
			{ type: "text", sub_type: "message", message_PT: "Chute Circular (Stun)", message_ES: "Patada Circular (Stun)", message: "Roundhouse Kick (Stun)", class_position: "tank", check_func: () => gettingserious },
		...
		"s-3203-1000-111-0": [{ type: "text", class_position: "tank", sub_type: "message", message_PT: "Derrubar", message_ES: "Tumbar", message: "Knockdown" }],
		"s-3203-1000-120-0": [{ type: "text", class_position: "tank", sub_type: "message", message_PT: "Derrubar", message_ES: "Tumbar", message: "Knockdown" }],
		"s-3203-1000-153-0": [{ type: "text", class_position: "tank", sub_type: "message", message_PT: "2 chutes", message_ES: "2 Patada", message: "Two Kicks" }], // 153 108
		"s-3203-1000-121-0": [{ type: "text", sub_type: "message", message_PT: "Giro + Chute(Stun)", message_ES: "Giro + Patada (Stun)", message: "Flip Kick (Stun)" }],
		"qb-3203-1000-32031000": [{ type: "text", sub_type: "message", message_PT: "Bait (Iframe)", message_ES: "Bait (Iframe)", message: "Bait (Dodge)" }],
		...
		"s-3203-1000-115-0": [{ type: "text", sub_type: "message", message_PT: "Golpe Frontal (Haymaker)", message_ES: "Golpe Frontal (Haymaker)", message: "Haymaker (Tank)" }],
		"s-3203-1000-131-0": [{ type: "text", sub_type: "message", message_PT: "Ritmico Golpes", message_ES: "Ritmico Golpes", message: "Rhythmic Blows" }], // 131 132 133
		// 116 146
		"s-3203-1000-146-0": [
		...
		// Shield
		"qb-3203-1000-32031006": [{ type: "text", sub_type: "message", message_PT: "ESCUDO!", message_ES: "ESCUDO", message: "Shield!" }],
		...
		// Donuts
		"qb-3203-1000-32031008": [{ type: "text", sub_type: "message", message_PT: "SAIR - ENTRAR (Donuts)", message_ES: "SALIR - ENTRAR (Donuts)", message: "Donuts: Out > In > Dodge" }], // 32031008 303/304 117 155
		"qb-3203-1000-32031009": [{ type: "text", sub_type: "message", message_PT: "ENTRAR - SAIR (Donuts)", message_ES: "ENTRAR - SALIR (Donuts)", message: "Donuts: In > Out > Dodge" }], // 32031009 303/304 118 155
		"s-3203-1000-303-0": [
		...
		"s-3203-1000-155-0": [{ type: "text", sub_type: "message", delay: 50, message_PT: "Iframe", message_ES: "Iframe", message: "Dodge" }],

		// Stun 142 148 129
		"s-3203-1000-142-0": [{ type: "text", sub_type: "message", message_PT: "Ondas Atrás | Stun", message_ES: "Olas Atrás | Stun", message: "Stun | Back Wave" }],
		"s-3203-1000-148-0": [
		...
		// Jump 143-0 143-1
		"qb-3203-1000-32031001": [{ type: "text", sub_type: "message", message_PT: "Bait Res", message_ES: "Bait Res", message: "Bait on Res" }],
		"s-3203-1000-143-0": [{ type: "text", sub_type: "message", message_PT: "Pulo (Stun)", message_ES: "Salto (Stun)", message: "Jump (Stun)" }],
		"s-3203-1000-143-1": [{ type: "spawn", func: "circle", args: [true, 553, 0, 0, 14, 240, 0, 2000] }],

		// AoE 313 314
		"s-3203-1000-313-0": [{ type: "text", sub_type: "message", message_PT: "AOE", message_ES: "AOE", message: "AOE" }],
		"s-3203-1000-314-0": [{ type: "text", sub_type: "message", message_PT: "SAIR", message_ES: "SALIR", message: "Get Out" }],

		// Explosion 32031003 152 / 135
		"s-3203-1000-152-0": [
			{ type: "text", sub_type: "message", message_PT: "Explosão (Stun)", message_ES: "Explosión (Stun)", message: "Explosion (Stun)" },
			{ type: "text", sub_type: "message", delay: 1000, message_PT: "Iframe", message_ES: "Iframe", message: "Dodge" },
			{ type: "spawn", func: "circle", args: [true, 912, 0, 0, 8, 460, 0, 2500] },
			{ type: "text", sub_type: "alert", delay: 58000, message_PT: "Explosão Em Breve...", message_ES: "Explosión Pronto...", message: "Explosion soon..." }
		],
		"s-3203-1000-135-0": [
			{ type: "text", sub_type: "message", message_PT: "Explosão (Stun)", message_ES: "Explosión (Stun)", message: "Explosion (Stun)" },
			{ type: "text", sub_type: "message", delay: 1000, message_PT: "Iframe", message_ES: "Iframe", message: "Dodge" },
		...
		// Debuff
		"ae-0-0-32031011": [{ type: "text", sub_type: "alert", message_PT: "Debuff Stack", message_ES: "Debuff Stack", message: "Debuff Stack" }],
		"am-3203-1000-32031011": [{ type: "text", sub_type: "alert", message_PT: "Debuff Stack", message_ES: "Debuff Stack", message: "Debuff Stack" }],
		"am-3203-1000-32031012": [{ type: "text", sub_type: "alert", message_PT: "Debuff Stack", message_ES: "Debuff Stack", message: "Debuff Stack" }]
	};
};