...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	return {
		...
		"qb-3040-1000-32042000": [
			...
			{ type: "text", sub_type: "alert", message: "Esquiva", message_PT: "Esquiva", delay: 1450 },
			{ type: "func", func: () => combo_count = 0 }
		],
		"h-3040-1000-35": [{ type: "text", sub_type: "message", message: "35%", message_PT: "35%" }],
		"qb-3040-1000-32041000": [{ type: "text", sub_type: "alert", message: "combo Pizza em Breve", message_PT: "Combo Pizza em Breve" }],

		"s-3040-1000-104-0": [
			{ type: "text", sub_type: "message", message: "Stun (AOE)", message_PT: "Stun (AOE)" },
			{ type: "text", sub_type: "message", message: "Iframe", message_PT: "Iframe", delay: 800 },
			{ type: "spawn", func: "circle", args: [true, 553, 180, -50, 10, 380, 0, 2000] }
		],
		"s-3040-1000-107-0": [
			{ type: "text", sub_type: "message", message: "Line Forward + Side Lines", message_PT: "Linhas no Meio e	Laterais + PIZZA" },
		...
		"s-3040-1000-112-0": [{ type: "text", sub_type: "message", message: "Wave Forward", message_PT: "Empurrar a Frente" },
			{ type: "spawn", func: "vector", args: [553, 0, 0, 70, 500, 0, 2000] },
			{ type: "spawn", func: "vector", args: [553, 0, 0, 290, 500, 0, 2000] }
		],
		"s-3040-1000-114-0": [{ type: "text", sub_type: "message", message: "Inner + Outer AOEs", message_PT: "AOEs Dentro e Fora + GIRO" }],
		"s-3040-1000-116-0": [
		...
		"s-3040-1000-119-0": [{ type: "text", sub_type: "message", message: "Two Strikes", message_PT: "Dois Golpes" }],
		"s-3040-1000-120-0": [
			{ type: "text", sub_type: "message", message: "Two Strikes + Stun (AOE)", message_PT: "Explosão Ampla Stun" },
			{ type: "text", sub_type: "message", message: "Esquiva", message_PT: "Iframe", delay: 2250 },
			{ type: "spawn", func: "circle", args: [true, 553, 180, -100, 10, 700, 0, 2500], delay: 1500 }
		],
		"s-3040-1000-123-0": [{ type: "text", sub_type: "message", message: "Spin", message_PT: "Giro" }],
		"s-3040-1000-125-0": [{ type: "text", sub_type: "message", message: "Stun (Tank)", message_PT: "Stun (Tank)" }],
		"s-3040-1000-127-0": [
		...
		"s-3040-1000-156-0": [{ type: "text", sub_type: "message", message: "Get Skulls", message_PT: "Cabeças" }],
		"s-3040-1000-157-0": [{ type: "text", sub_type: "alert", message: "Gather!", message_PT: "Juntar!", delay: 5000 }],
		"s-3040-1000-158-0": [{ type: "text", sub_type: "alert", message: "Gather!", message_PT: "Juntar!", delay: 5000 }],
		"s-3040-1000-159-0": [{ type: "text", sub_type: "message", message: "AOE", message_PT: "АОЕ" }]
	};
};