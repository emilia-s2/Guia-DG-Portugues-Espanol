...
module.exports = {
  ...
  "s-982-1000-107-0": [{ "type": "text", "class_position":"dps", "sub_type": "message", "message": "Empurrar (Repelir)", "message_TW": "后喷击退" },
                        { "type": "text", "class_position":"heal", "sub_type": "message", "message": "Empurrar (Repelir)", "message_TW": "后喷击退" }],
  "s-982-1000-108-0": [{ "type": "text", "class_position":"dps", "sub_type": "message", "message": "Espinhos no Chao", "message_TW": "点名击飞" },
                        { "type": "text", "class_position":"heal", "sub_type": "message", "message": "Espinhos no Chao", "message_TW": "点名击飞" }], 
  "s-982-1000-109-0": [{ "type": "text", "sub_type": "message", "message": "Rochas (pequena)", "message_TW": "滚石" }],
  "s-982-1000-110-0": [{ "type": "text", "sub_type": "message", "message": "Rochas (Grande)", "message_TW": "滚石" }],
  "s-982-1000-301-0": [{ "type": "text", "sub_type": "message", "message": "Flor Canibal (Stun)", "message_TW": "食人花眩晕" }], 
  "s-982-1000-307-0": [{ "type": "text", "sub_type": "message", "message": "Gaiola (proibida)", "message_TW": "笼子禁锢" }], // Alterado de DPS para Geral
//                        {"type": "text","class_position":"heal","sub_type": "message","message": "Gaiola (proibida)","message_TW": "子禁锢"}], // removido
  ...
  "s-982-1000-116-0": [{ "type": "text", "sub_type": "message", "message": "Ataque em tela cheia!!", "message_TW": "全屏攻击!!" }],
  "s-982-1000-312-0": [{ "type": "text", "sub_type": "message", "message": "Flor Dourada!!", "message_TW": "金色花!!" }],
  ...
  "s-982-2000-113-0": [{ "type": "text", "sub_type": "message", "message": "Maos Stun", "message_TW": "双手眩晕" },
  ...
  "s-982-2000-301-0": [{ "type": "text", "sub_type": "message", "message": "SAIR + ESQUIVAR", "message_TW": "捶地远离 旋转击退" },
 	{ "type": "func", "func": Spawnitem2.bind(null, 553, 0, 0, 12, 260, 0, 3500) }   
  ],
  ...
  "s-982-3000-143-0": [{ "type": "text", "sub_type": "message", "message": "ESQUERDA Atras ataque", "message_TW": "左后" },
  { "type": "func", "func": skilld_event.bind(null, 143) }
  ],
  "s-982-3000-145-0": [{ "type": "text", "sub_type": "message", "message": "ESQUERDA Atras ataque", "message_TW": "左后" },
  { "type": "func", "func": skilld_event.bind(null, 145) }
  ],
  "s-982-3000-146-0": [{ "type": "text", "sub_type": "message", "message": "ESQUERDA Atras (Pulsos)", "message_TW": "左后扩散" },
  ...
  "s-982-3000-154-0": [{ "type": "text", "sub_type": "message", "message": "ESQUERDA (Pulsos)", "message_TW": "左后扩散" },
  { "type": "func", "func": SpawnThing.bind(null, 215, 370, 6000) },
  { "type": "func", "func": Spawnitem2.bind(null, 553, 215, 370, 15, 160, 2500, 6000) },
  //    {"type": "func","func": Spawnitem2.bind(null,445,215,370,12,320,2500,8000)},
  //     {"type": "func","func": Spawnitem2.bind(null,445,215,370,10,480,2500,8000)},
  ...
  "s-982-3000-144-0": [{ "type": "text", "sub_type": "message", "message": "DIREITA Atras ataque", "message_TW": "右后" },
  { "type": "func", "func": skilld_event.bind(null, 144) }],


  "s-982-3000-147-0": [{ "type": "text", "sub_type": "message", "message": "DIREITA Atras ataque", "message_TW": "右后" },
  { "type": "func", "func": skilld_event.bind(null, 147) }],

  "s-982-3000-148-0": [{ "type": "text", "sub_type": "message", "message": "DIREITA Atras (Pulsos)", "message_TW": "右后扩散" },
  ...
  "s-982-3000-155-0": [{ "type": "text", "sub_type": "message", "message": "DIREITA Atras (Pulsos)", "message_TW": "右后扩散" },
  { "type": "func", "func": SpawnThing.bind(null, 155, 388, 6000) },
  { "type": "func", "func": Spawnitem2.bind(null, 553, 155, 388, 15, 160, 2500, 6000) },
  //     {"type": "func","func": Spawnitem2.bind(null,445,155,388,12,320,2500,8000)},
  //     {"type": "func","func": Spawnitem2.bind(null,445,155,388,10,480,2500,8000)},
  ...
  "s-982-3000-213-0": [{ "type": "text", "sub_type": "message", "message": "Cauda", "message_TW": "尾巴" },
  { "type": "func", "func": skilld_event.bind(null, 213) }
  ],
  "s-982-3000-215-0": [{ "type": "text", "sub_type": "message", "message": "Cauda!!", "message_TW": "尾巴!!" },
  { "type": "func", "func": skilld_event.bind(null, 215) }
  ],
  "s-982-3000-139-0": [{ "type": "text", "sub_type": "message", "message": "Esquerdo Seguro", "message_TW": "打右边" },
  ...
  "s-982-3000-150-0": [{ "type": "text", "sub_type": "message", "message": "Direito Seguro", "message_TW": "打右边" },
  { "type": "func", "func": Spawnitem1.bind(null, 912, 0, 500, 5000) },
  { "type": "func", "func": Spawnitem1.bind(null, 912, 180, 500, 5000) },
  { "type": "func", "func": SpawnThing.bind(null, 270, 200, 8000) },
  { "type": "func", "func": skilld_event.bind(null, 150) }],
  "s-982-3000-141-0": [{ "type": "text", "sub_type": "message", "message": "Esquerdo Seguro", "message_TW": "打左边" },
  { "type": "func", "func": Spawnitem1.bind(null, 912, 0, 500, 5000) },
  { "type": "func", "func": Spawnitem1.bind(null, 912, 180, 500, 5000) },
  { "type": "func", "func": SpawnThing.bind(null, 90, 200, 8000) },
  { "type": "func", "func": skilld_event.bind(null, 141) }],
  "s-982-3000-152-0": [{ "type": "text", "sub_type": "message", "message": "Direito Seguro", "message_TW": "打左边" },
  { "type": "func", "func": Spawnitem1.bind(null, 912, 0, 500, 5000) },
  { "type": "func", "func": Spawnitem1.bind(null, 912, 180, 500, 5000) },
  { "type": "func", "func": SpawnThing.bind(null, 90, 200, 8000) },
  { "type": "func", "func": skilld_event.bind(null, 152) }],
  "s-982-3000-300-0": [{ "type": "text", "sub_type": "message", "message": "DESPERTAR (Iframe)", "message_TW": "一次觉醒 推人" },
  { "type": "func", "func": skilld_event.bind(null, 300) }],
  "s-982-3000-399-0": [{ "type": "text", "sub_type": "message", "message": "Despertar Secundario (Iframe)", "message_TW": "二次觉醒 推人" },
  { "type": "func", "func": skilld_event.bind(null, 399) }

  ],
  "s-982-3000-360-0": [{ "type": "text", "sub_type": "message", "message": "EXPLOSAO - EXPLOSAO!!", "message_TW": "爆炸爆炸" },
