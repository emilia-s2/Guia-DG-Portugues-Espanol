	...
	function debuff_added(id) {
		...
		timer1 = dispatch.setTimeout(() => {
			if (debuff != null) {
				handlers.text({
					sub_type: "message",
					message: "Fim do Debuff em 20 segundos",
...
/*				handlers.text({
	...
	const skills = {
		...
		"108-0": [
			{ type: "text", sub_type: "message", message: "Giro a Direita (Repelir!)", message_RU: "Поворот вправо (откид)" },
		...
		"109-0": [
			{ type: "text", sub_type: "message", message: "Giro a Esquerda (Repelir!)", message_RU: "Поворот влево (откид)" },
			{ type: "spawn", func: "circle", args: [false, 912, 0, 0, 8, 440, 0, 2000] }
		],
		"159-0": [
			{ type: "text", sub_type: "message", message: "Giro a Esquerda (Repelir!)", message_RU: "Поворот влево (откид)" },
		...
		"145-0": [{ type: "text", sub_type: "message", message: "Pes (Stun)", message_RU: "Стан" }],
...
//		"118-1": [{ type: "text", sub_type: "message", message: "Dodge", message_RU: "Эвейд!" }],
		...
		// AOE огонь (большой)
		"105-0": [
			{ type: "text", sub_type: "message", message: "AOE de FOGO (GRANDE)", message_RU: "Огненные бомбы" },
		...
		// AOE лед (малый)
		"154-0": [
			{ type: "text", sub_type: "message", message: "Magia de GELO (Pequeno)", message_RU: "Ледяной шторм" },
...
//		"206-2": [{ type: "spawn", func: "circle", args: [false, 553, 0, 0, 15, 350, 0, 3000] }],
		...
		"139-0": [
			{ type: "text", sub_type: "message", message: "[Temperatura] 60+ TODOS (GELO)", message_RU: "60° (Огонь всем)" }
//			{ type: "text", sub_type: "message", delay: 4000, message: "Lower the temp", message_RU: "Снизить температуру" }
		],
		"140-0": [
			{ type: "text", sub_type: "message", message: "[Temperatura] 40- TODOS (FOGO)", message_RU: "40° (Лед всем)" }
