...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	return {
		...
		"s-3209-2000-604-0": [
			...
			{ type: "text", sub_type: "message", message: "Cage (In)", message_PT: "Prisão (Entrar)", message_ES: "Jaula (Entrar)" },
		...
		//
		"qb-3209-2000-32092011": [{ type: "text", sub_type: "message", message: "Debuff", message_PT: "Debuff", message_ES: "Debuff" }],
		// Dakuryon
		"s-3209-2750-301-0": [
			{ type: "text", sub_type: "message", message: "Dakuryon", message_PT: "Dakuryon", message_ES: "Dakuryon" },
