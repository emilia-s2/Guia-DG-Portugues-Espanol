...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	return {
		...
		"s-780-1000-112-0": [{ type: "text", sub_type: "message", message: "Jump Fowrard", message_ES: "Salto Adelante", message_PT: "Salto Frontal" }],
		...
		"s-780-2000-105-0": [{ type: "text", sub_type: "message", message: "Heavy Front Attack (Stun)", message_ES: "Ataque Frontal Fuerte (Stun)", message_PT: "Ataque Frontal Forte (Stun)" }],
		...
		"s-780-2000-106-2": [{ type: "text", sub_type: "message", message: "Dodge", message_ES: "Iframe", message_PT: "Iframe", delay: 200 }],
		...
		"s-780-3000-113-0": [{ type: "text", sub_type: "message", message: "Pushback", message_ES: "Empujar", message_PT: "Empurrar" }], // left
		"s-780-3000-114-0": [{ type: "text", sub_type: "message", message: "Pushback", message_ES: "Empujar", message_PT: "Empurrar" }], // right
		...
		"s-780-3000-309-0": [{ type: "text", sub_type: "message", message: "Jump", message_ES: "Salto", message_PT: "Salto" }]
	};
};