...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	const mech_messages = {
		0: { message: "Out", message_ES: "Salir", message_PT: "Sair" },
		1: { message: "In", message_ES: "Entrar", message_PT: "Entrar" },
		2: { message: "Wave", message_ES: "Ola", message_PT: "Onda" },
		3: { message: "?", message_ES: "?", message_PT: "?" }
	};
	...
	function thirdboss_sattack_event(skillid) {
		...
		if ([1160, 1190].includes(skillid)) {
			handlers.text({ sub_type: "message", message: "Right Safe", message_ES: "DERECHA Seguro", message_PT: "DIREITA Seguro" });
		}
		if ([1170, 1180].includes(skillid)) {
			handlers.text({ sub_type: "message", message: "Left Safe", message_ES: "IZQUIERDA Seguro", message_PT: "ESQUERDA Seguro" });
		}
	...
	return {
		...
		"qb-935-1000-935101": [{ type: "text", sub_type: "message", message: "Pizza", message_ES: "Pizza", message_PT: "Pizza" }],
		"qb-935-1000-935102": [{ type: "text", sub_type: "message", message: "AOE! Jump", message_ES: "AOE! SALTAR", message_PT: "AOE PULAR" }],
		"s-935-1000-104-0": [{ type: "text", sub_type: "message", message: "Front Clip", message_ES: "Stun Frontal", message_PT: "Stun Frontal" }],
		"s-935-1000-108-0": [{ type: "text", sub_type: "message", message: "Get Out", message_ES: "SALIR", message_PT: "SAIR" }], // крутилка
		"s-935-1000-111-0": [{ type: "text", sub_type: "message", message: "Back + Front", message_ES: "Atrás | Frente Ataque", message_PT: "Atrás | Frente Ataque" }],
		"s-935-1000-112-0": [{ type: "text", sub_type: "message", message: "Back", message_ES: "Ataque Atrás", message_PT: "Ataque Atrás" }],
		"s-935-1001-205-0": [{ type: "text", sub_type: "message", message: "Wind (Kaia)", message_ES: "Ventilador (Kaia)", message_PT: "Ventilador (Kaia)" }],
		...
		"s-935-1000-304-0": [{ type: "text", sub_type: "message", message: "Out", message_ES: "SALIR", message_PT: "SAIR" }],
		"s-935-1000-305-0": [{ type: "text", sub_type: "message", message: "In", message_ES: "ENTRAR", message_PT: "ENTRAR" }],
		"s-935-1000-306-0": [{ type: "text", sub_type: "message", message: "Bombs", message_ES: "Bombas", message_PT: "Bombas" }],
		"s-935-1000-307-0": [{ type: "text", sub_type: "message", message: "Pull", message_ES: "Jalar", message_PT: "Puxar" }],
		"s-935-1000-309-0": [
		...
		"s-935-2000-308-0": [{ type: "text", sub_type: "message", message: "Left", message_ES: "Izquierda", message_PT: "Direita" }],
		"s-935-2000-309-0": [{ type: "text", sub_type: "message", message: "Right", message_ES: "Derecha", message_PT: "Esquerda" }],
		"s-935-2007-201-0": [
		...
		//
		"s-935-3000-125-0": [{ type: "text", sub_type: "message", message: "Front", message_ES: "Frente", message_PT: "Frente" }],
		"s-935-3000-126-0": [{ type: "text", sub_type: "message", message: "Front | Back", message_ES: "Frente | Atrás", message_PT: "Frente | Atrás" }],
		"s-935-3000-127-0": [{ type: "text", sub_type: "message", message: "Back", message_ES: "Atrás", message_PT: "Atrás" }],
		"s-935-3000-128-0": [
		...
		"s-935-3000-129-0": [{ type: "text", class_position: "tank", sub_type: "message", message: "Dodge", message_ES: "Iframe", message_PT: "Iframe" }],
		...
		// Radar
		"qb-935-3000-935312": [{ type: "text", sub_type: "message", message: "!!! Radar !!!", message_ES: "!!! Radar !!!", message_PT: "!!! Radar !!!" }],
		"s-935-3000-324-0": [
