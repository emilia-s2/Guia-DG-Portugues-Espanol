...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	return {
		...
		"s-754-1000-1106-0": [{ type: "text", sub_type: "message", message_PT: "Cículo Aleatório", message_ES: "Cículo Aleatorio", message: "Random Circle" }],
		...
		"s-754-1002-1110-0": [{ type: "text", sub_type: "message", message_PT: "Mudança de Marcha", message_ES: "Barrido Engranajes", message: "Gear Sweep" }],
		...
		"s-754-1002-3113-0": [{ type: "text", sub_type: "message", message_PT: "Quebrar ESCUD", message_ES: "ROMPER ESCUDO", message: "BREAKE SHIELD" }],

		"s-754-1002-3119-0": [{ type: "text", sub_type: "message", message_PT: "Ataque de Onda (Ir Centro)", message_ES: "Ataque de Ola (Ir Centro)", message: "Wave Attack (Go Center)" }],
		"qb-754-1002-754001": [{ type: "text", sub_type: "alert", message_PT: "Bola Eletrônica", message_ES: "Esfera Eléctrica", message: "Electric Ball" },
			{ type: "text", sub_type: "alert","delay": 45000, message_PT: "Bola Eletrônica Pronta", message_ES: "Esfera Eléctrica Lista", message: "Electric Ball Ready" }
		],
		// Ataques especiais
