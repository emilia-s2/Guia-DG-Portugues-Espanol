...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	return {
		...
		"s-939-1000-117-0": [{ type: "text", sub_type: "message", message: "Jump + Spin", message_ES: "Salto + Giro", message_PT: "Salto + Giro" }],
		...
		"s-939-3001-201-0": [
			...
			{ type: "text", sub_type: "message", delay: 3600, message: "Dodge!", message_ES: "Iframe!", message_PT: "Iframe!" },
		...
		"s-939-3001-115-0": [
			{ type: "text", sub_type: "message", message: "Strong Roar (Stun)", message_PT: "Rugido Fuerte (Stun)", message_PT: "Rugido Forte (Stun)" },
