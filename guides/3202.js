...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	return {
		...
		"s-3202-1000-1107-0": [{ type: "text", sub_type: "message", message: "Spectral Throw (Bait)", message_ES: "Lanza Spectral", message_PT: "Arremesso Spectral" },
			{ type: "text", sub_type: "message", delay: 1400, message: "Dodge!", message_ES: "Iframe!", message_PT: "Iframe!" }
		],
		"s-3202-1000-2107-0": [{ type: "text", sub_type: "message", message: "Spectral Throw (Bait)", message_ES: "Lanza Spectral", message_PT: "Arremesso Spectral" },
			{ type: "text", sub_type: "message", delay: 1400, message: "Dodge!", message_ES: "Iframe!", message_PT: "Iframe!" }
		],
		// Basic attacks
		"s-3202-1000-1103-0": [{ type: "text", sub_type: "message", message: "2 Hits | Bleed", message_ES: "2 Hits | Sangrar", message_PT: "2 Hits | Sangrar" }],
		"s-3202-1000-2103-0": [{ type: "text", sub_type: "message", message: "2 Hits | Bleed", message_ES: "2 Hits | Sangrar", message_PT: "2 Hits | Sangrar" }],
		"s-3202-1000-1113-0": [{ type: "text", sub_type: "message", message: "4 Hits Combo", message_ES: "4 Hits Combo", message_PT: "4 Hits Combo" }],
		"s-3202-1000-2113-0": [{ type: "text", sub_type: "message", message: "4 Hits Combo", message_ES: "4 Hits Combo", message_PT: "4 Hits Combo" }],
		"s-3202-1000-1105-0": [{ type: "text", sub_type: "message", message: "Uppercut | Stun", message_ES: "Corte | Stun", message_PT: "Corte | Stun" }],
		"s-3202-1000-2105-0": [{ type: "text", sub_type: "message", message: "Uppercut | Stun", message_ES: "Corte | Stun", message_PT: "Corte | Stun" }],
		"s-3202-1000-1106-0": [{ type: "text", sub_type: "message", message: "Stun", message_ES: "Stun", message_PT: "Stun" }],
		"s-3202-1000-2106-0": [{ type: "text", sub_type: "message", message: "Stun", message_ES: "Stun", message_PT: "Stun" }],
		// 120 > 114
		"s-3202-1000-1120-0": [
		...
		"s-3202-1000-1111-0": [{ type: "text", sub_type: "message", message: "Leap (Stun)", message_ES: "Salto (Stun)", message_PT: "Salto (Stun)" },
			{ type: "text", sub_type: "message", delay: 1800, message: "Dodge!", message_ES: "Iframe", message_PT: "Iframe!" }
		],
		"s-3202-1000-2111-0": [{ type: "text", sub_type: "message", message: "Leap (Stun)", message_ES: "Salto (Stun)", message_PT: "Salto (Stun)" },
		...
		"s-3202-1000-1304-0": [{ type: "text", sub_type: "message", message: "Shield!", message_ES: "ESCUDO", message_PT: "ESCUDO!" }],
		"s-3202-1000-2304-0": [{ type: "text", sub_type: "message", message: "Shield!", message_ES: "ESCUDO", message_PT: "ESCUDO!" }],
