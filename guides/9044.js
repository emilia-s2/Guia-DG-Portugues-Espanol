...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	function skilld_event(skillid,  ent) {
		...
		if ([1121, 2121, 1140, 2140, 1123, 2123, 1142, 2142, 1122, 2122, 1141, 2141].includes(skillid)) {
			handlers.event([
				...
				{ type: "text", sub_type: "alert", delay: 60000, message: "Ondas em Breve...", message_RU: "Скоро волны..." }
			]);
		}
	...
	return {
		...
		"s-444-1000-2118-0": [{ type: "text", sub_type: "message", message: "Pular (Tank)", message_RU: "Прыжок (танк)" }],
		"s-444-1000-2121-0": [{ type: "text", sub_type: "message", message: "Ondas (ESQUERDA)", message_RU: "Волны (левая)" }, { type: "func", func: skilld_event, args: [2121] }],
		//
		"s-444-1000-2131-0": [
...
//			{ type: "spawn", func: "circle", args: [false, 912, 0, 0, 8, 360, 0, 2000] }
		...
		"s-444-1000-1118-0": [{ type: "text", sub_type: "message", message: "Pular (Tank)", message_RU: "Прыжок (танк)" }],
		"s-444-1000-1121-0": [
...
//		],
		...
		"s-444-2000-1118-0": [{ type: "text", sub_type: "message", message: "Pular (Tank)", message_RU: "Прыжок (танк)" }],
		"s-444-2000-1119-0": [
