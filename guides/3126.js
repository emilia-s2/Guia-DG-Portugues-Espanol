...
let skills = {
	...
	"108-0": [{ "type": "text", "sub_type": "message", "message": "Vire a Direita (Repelir!)", "message_RU": "Поворот вправо (откид!!)" }, { "type": "spawn_func", "func": "circle", "args": [false, 912, 0, 0, 8, 440, 0, 2000] }],
	"158-0": [{ "type": "text", "sub_type": "message", "message": "Vire a Direita (Repelir!)", "message_RU": "Поворот вправо (откид!!)" }, { "type": "spawn_func", "func": "circle", "args": [false, 912, 0, 0, 8, 440, 0, 2000] }],
	"109-0": [{ "type": "text", "sub_type": "message", "message": "Vire a Esquerda (Repelir!)", "message_RU": "Поворот влево (откид!!)" }, { "type": "spawn_func", "func": "circle", "args": [false, 912, 0, 0, 8, 440, 0, 2000] }],
	"159-0": [{ "type": "text", "sub_type": "message", "message": "Vire a Esquerda (Repelir!)", "message_RU": "Поворот влево (откид!!)" }, { "type": "spawn_func", "func": "circle", "args": [false, 912, 0, 0, 8, 440, 0, 2000] }],
...
//	"206-2": [{ "type": "spawn_func", "func": "circle", "args": [false, 553, 0, 0, 15, 350, 0, 3000] }],
	...
	"139-0": [{ "type": "text", "sub_type": "message", "message": "60+ Todos (Fogo)", "message_RU": "60° (Огонь всем)" },
			  { "type": "text", "sub_type": "message", "delay": 4000, "message": "Aumente a temperatura", "message_RU": "Снизить температуру" }
	],
	"140-0": [{ "type": "text", "sub_type": "message", "message": "40- Todos (Gelo)", "message_RU": "40° (Лед всем)" },
	...
	"am-3126-1000-31260068": [
		...
		{ "type": "text", "sub_type": "message", "delay": 145000, "message": '[Debuff] 2.5 minutos passados', "message_RU": "[Дебафф] Прошло 2.5 минуты (стаки удалены)" }
	]
};
