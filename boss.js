module.exports = {
	// 进入副本提示文
	DungeonInfo : [
		{zone: 9767, string: '<font color="#ff5cde">Bem-Vindo a</font> <font color="#8eff05">Demokron Factory</font> <font color="#09c0e1">Normal</font>'},
		{zone: 9067, string: '<font color="#ff5cde">Bem-Vindo a</font> <font color="#8eff05">Demokron Factory</font> <font color="#d92b3c">Dificil</font>'},
		{zone: 9770, string: '<font color="#ff5cde">Bem-Vindo a</font> <font color="#8eff05">Ruinous Manor</font> <font color="#09c0e1">Normal</font>'},
		{zone: 9970, string: '<font color="#ff5cde">Bem-Vindo a</font> <font color="#8eff05">Ruinous Manor</font> <font color="#d92b3c">Dificil</font>'},
		...
		{zone: 9920, string: '<font color="#ff5cde">Bem-Vindo a</font> <font color="#8eff05">Antaroth Abyss</font> <font color="#d92b3c">Dificil</font>'},
		{zone: 3017, string: '<font color="#ff5cde">Bem-Vindo a</font> <font color="#8eff05">Antaroth Abyss</font> <font color="#FF0000"> 7 Pessoas</font>'},
		{zone: 9783, string: '<font color="#ff5cde">Bem-Vindo a</font> <font color="#8eff05">Dark Reach Citadel</font> <font color="#09c0e1">Normal</font>'},
		{zone: 9983, string: '<font color="#ff5cde">Bem-Vindo a</font> <font color="#8eff05">Dark Reach Citadel</font> <font color="#d92b3c">Dificil</font>'},
		{zone: 3018, string: '<font color="#ff5cde">Bem-Vindo a</font> <font color="#8eff05">Dark Reach Citadel</font> <font color="#FF0000"> 7 Pessoas</font>'},
		{zone: 9782, string: '<font color="#ff5cde">Bem-Vindo a</font> <font color="#8eff05">Grotto of Lost Souls</font> <font color="#09c0e1">Normal</font>'},
		{zone: 9982, string: '<font color="#ff5cde">Bem-Vindo a</font> <font color="#8eff05">Grotto of Lost Souls</font> <font color="#d92b3c">Dificil</font>'},
		{zone: 3019, string: '<font color="#ff5cde">Bem-Vindo a</font> <font color="#8eff05">Grotto of Lost Souls</font> <font color="#FF0000"> 7 Pessoas</font>'},		
		{zone: 3101, string: '<font color="#ff5cde">Bem-Vindo a</font> <font color="#8eff05">Gossamer Vault</font> <font color="#09c0e1">Normal</font>'},
		{zone: 3201, string: '<font color="#ff5cde">Bem-Vindo a</font> <font color="#8eff05">Gossamer Vault</font> <font color="#d92b3c">Dificil</font>'},
		{zone: 3023, string: '<font color="#ff5cde">Bem-Vindo a</font> <font color="#8eff05">Akalath Quarantine</font>'},
...
/*		{id: 106, msg: 'Atras'},
	...
	VS_TipMsg : ["Proximo -> ", "(Debuff) Perto", "(Raios) Espalhar", "(Bombas) Juntar + Claense", "(Debuff) Longe", "(Raios) Juntar", "(Bombas) Juntar No Cleanse"],
	// RK-9机库 (RK-9 Kennel)
	RK_BOSS_1 : [
...
//		{id: 175, msg: 'Rugido Forte (tontura)'},
...
/*		{id: 113, msg: 'Frente - Atras stun'},
		...
		{id: 310, msg: 'Onda de agua 1'},
		{id: 311, msg: 'Onda de agua 2'},
		{id: 312, msg: 'Onda de agua 3'},
		{id: 313, msg: 'Onda de agua 4'},
		{id: 314, msg: 'Onda de agua 5'}
...
//---------------------------------------------------------------------------------------//
//		{id: 3119, msg: 'Maldicao ', TIP: ["SAIR", "ENTRAR"]}, // 红出 | 蓝进		original
//		{id: 3220, msg: 'Maldicao ', TIP: ["ENTRAR", "SAIR"]}  // 红进 | 蓝出     original
	],
	AQ_BOSS_2 : [
...
/*		{id: 108, msg: 'Ataque a Frente'},
	...
	SI_TipMsg : [//"SAIR-ENTRAR-ENTRAR", "ENTRAR-SAIR-ENTRAR","Bruxa!!!", "SAIR-ENTRAR-SAIR", "ENTRAR-SAIR-SAIR"
	],
...
//		{id: 357, msg: 'SAIR + Explosao (Iframe)'}, // 357 吸收力量 -> 110 起身攻擊 -> 氣斬
		{id: 350, msg: 'SAIR-> ENTRAR (Donuts)'},     // 350 吸收力量                 -> 302 甜甜圈
